...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "import_confirm": "Import {count} subscription(s)?",
        "import_confirm_dups": "Import {count} subscription(s)?\n{dups} look like duplicates of existing rows.",
    ...
    "ja": {
        ...
        "import_confirm": "{count}件のサブスクを読み込みますか？",
        "import_confirm_dups": "{count}件を読み込みますか？\n{dups}件は既存と重複の可能性があります。",
        "import_cancelled": "読込をキャンセルしました",
